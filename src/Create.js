      ...
      <div className="intro-y box ml-12 mr-20 mt-3">
            ...
            <div className="mt-3">
                ...
                <div className="mt-3">
                    ...
                    <div className="text-xs text-gray-600 mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</div>
                </div>
                <div className="mt-3">
                ...
                <div className="mt-3 mb-6">
                    <label>Remark</label>
                    <input type="text" className="input w-full border mt-2 bg-gray-100 " placeholder="" disabled=""/>
                </div>
